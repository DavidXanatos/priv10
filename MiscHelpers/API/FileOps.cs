...
namespace MiscHelpers
{
    public class FileOps
    {
        ...
        static public void SetAnyDirSec(string filePath)
        {
            ...
            security.AddAccessRule(new FileSystemAccessRule(new SecurityIdentifier(SID_World), FileSystemRights.Modify, InheritanceFlags.ContainerInherit, PropagationFlags.None, AccessControlType.Allow));
            security.AddAccessRule(new FileSystemAccessRule(new SecurityIdentifier(SID_World), FileSystemRights.Modify, InheritanceFlags.ObjectInherit, PropagationFlags.None, AccessControlType.Allow));
