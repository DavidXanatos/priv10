...
public class RegistryMonitor : IDisposable
{
	...
	private static extern int RegNotifyChangeKeyValue(IntPtr hKey, bool bWatchSubtree,
		                                                RegChangeNotifyFilters dwNotifyFilter, IntPtr hEvent,
		                                                bool fAsynchronous);
	...
	private RegChangeNotifyFilters _regFilter = RegChangeNotifyFilters.Key | RegChangeNotifyFilters.Attribute |
		                                        RegChangeNotifyFilters.Value | RegChangeNotifyFilters.Security;
